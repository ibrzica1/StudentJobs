...
<head>
    ...
    <title>{{ __('studentInfoMail.Application Accepted') }}</title>
</head>
                ...
                <tr>
                    <td style="padding:40px 40px 24px 40px; text-align:center;">
                        ...
                        <h1 style="margin:0 0 12px 0; font-size:24px; color:#212529; font-weight:700;">
                            {{ __('studentInfoMail.Application accepted') }}
                        </h1>

                        <p style="margin:0; font-size:15px; line-height:1.6; color:#6c757d;">
                            {{ __('studentInfoMail.You have accepted the application for your job. You can now contact the student directly using the contact information below.') }}
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:32px 40px;">
                        ...
                        <p style="margin:0; font-size:14px; line-height:1.6; color:#6c757d;">
                            {{ __('studentInfoMail.Please contact the student directly using the email address or phone number provided above to arrange the next steps.') }}
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="background-color:#f8f9fa; padding:24px 40px; text-align:center;">
                        ...
                        <p style="margin:0; font-size:13px; color:#adb5bd;">
                            {{ __('studentInfoMail.You are receiving this email because you accepted a student application on StudentJobs.') }}
                        </p>
                    </td>
                </tr>
