    ...
    <div class="flex justify-between items-center w-full">
        ...
        <div class="absolute top-full left-0 px-3 py-4 bg-[#f4bdbd] rounded-br-[10px] z-50" 
             ...
             wire:click.outside="showMenu = false">
                <a href="{{route('job.categories',['type' => 'employee'])}}" class="block px-4 py-2 hover:bg-white/50 rounded transition-colors text-gray-800">Find an employee</a>
                <a href="{{route('job.categories',['type' => 'helper'])}}" class="block px-4 py-2 hover:bg-white/50 rounded transition-colors text-gray-800">Find a helper</a>
        </div>
